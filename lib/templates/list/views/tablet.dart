        ...
        children: <Widget>[
                ...
                slivers: <Widget>[]
                  ...
                  ..add(Builder(
                    builder: (BuildContext context) {
                      SliverChildDelegate _childDelegate =
                          widget.childDelegate;
                      if (_childDelegate.estimatedChildCount == null &&
                          widget.nullItems != null)
                        return SliverFillRemaining(child: widget.nullItems);
                      if (_childDelegate.estimatedChildCount != null &&
                          _childDelegate.estimatedChildCount == 0 &&
                            ...
                            child: new IndexedSemantics(
                              ...
                              child: GestureDetector(
                                ...
                                child: new Container(
                                  ...
                                  child: _childDelegate.build(context, index),
                                ),
                              ),
                            ),
                          );
                        },
                        childCount: _childDelegate.estimatedChildCount ?? 0,
                        addAutomaticKeepAlives: false,
                        addRepaintBoundaries: false,
                        addSemanticIndexes: false,
                      ));
          ...
          Flexible(
            ...
            child: new _DetailView(
              ...
              details: _index == null ||
                      _index! > widget.childDelegate.estimatedChildCount! - 1
                  ? null
